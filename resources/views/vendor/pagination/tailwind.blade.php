@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="w-[90%] mx-auto pb-4 flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between sm:gap-x-4">
            <div class="text-left sm:justify-start">
            ...
            <div class="flex justify-center w-full">
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md gap-x-1.5">
                    {{-- Previous Page Link --}}
                    @if ($paginator->onFirstPage())
